...
//	//////////////////////////////////////////////////////////////////////////
//	static Mat4 perspective(const float angleofView, const float aspect, const float near, const float far);
...
//	static Mat4 Camera(const Vector3 & eye, const Vector3& target, const Vector3& up);
//
//	//static Mat4 lookAt(Camera& camera);
//	static Mat4 GetTranslation(const Vector3& translation);
//	static Mat4 GetTranslation(float xTranslation, float yTranslation, float zTranslation);
//
//	static Mat4 GetScaling(const Vector3& scale);
//	static Mat4 GetScaling(float scale);
//	static Mat4 GetScaling(float xScale, float yScale, float zScale);
//
//	static Mat4 GetRotation(const Vector3& axis, float angle);
//	static Mat4 GetRotationX(float angle);
//	static Mat4 GetRotationY(float angle);
//	static Mat4 GetRotationZ(float angle);
//
//	static Mat4 GetMatrixModel(const Mat4& scale, const Mat4& rotate, const Mat4& translate);
//	static Mat4 ModelToWorld(const Mat4& Model);
//	//////////////////////////////////////////////////////////////////////////
//	// Operator
//	//////////////////////////////////////////////////////////////////////////
...
//
//
//	//friend Mat4 operator*(Mat4 & mat1, Mat4& mat2);
//
...
//
//
//	friend Vector3& operator*=(Vector3&v, const Mat4& mat);
//
//private:
